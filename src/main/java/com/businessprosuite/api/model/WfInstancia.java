...
public class WfInstancia {
    ...
    private Set<WfHist> wfHists = new LinkedHashSet<>();

    @Builder.Default
    @OneToMany(mappedBy = "wfIns")
    private Set<com.businessprosuite.api.model.WfTimer> wfTimers = new LinkedHashSet<>();
